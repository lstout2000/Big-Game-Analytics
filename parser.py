        ...
        for page_number, page in enumerate(pdf.pages, start=1):
            ...
            for line in lines:
                ...
                records.append({
                    ...
                    "huntName": hunt_name,
                    "residency": "Resident",
                    "bonusPoints": int(resident_points),
                    "applicants": int(resident_applicants),
                    "bonusPermits": int(resident_bonus_permits),
                    "regularPermits": int(resident_regular_permits),
                    "totalPermits": int(resident_total_permits),
                    "successRatio": resident_success,
                })
                ...
                records.append({
                    ...
                    "bonusPoints": int(nonresident_points),
                    "applicants": int(nonresident_applicants),
                    "bonusPermits": int(nonresident_bonus_permits),
                    "regularPermits": int(nonresident_regular_permits),
                    "totalPermits": int(nonresident_total_permits),
                    "successRatio": nonresident_success,
                })
